...
with col_logo:
    ...
    <div style="margin-top:10px;">
        <a href="https://nexaedge-web-port.streamlit.app" target="_blank" style="display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#a2ff00,#8de600);color:#060b0f;font-family:'Space Mono',monospace;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;padding:8px 16px;border-radius:8px;text-decoration:none;">
...
# ══════════════════════════════════════
    ...
    if live2["online"] > 0 and hb2:
        ...
        st.markdown(f"""<div style="background:rgba(74,96,112,.05);border:1px solid #182230;border-left:3px solid #4a6070;border-radius:0 10px 10px 0;padding:10px 16px;font-family:'Space Mono',monospace;font-size:10px;color:#4a6070;margin-bottom:14px;">
            ...
            <a href="https://nexaedge-web-port.streamlit.app" target="_blank" style="color:#4a6070;">Activate yours -></a>
        </div>""", unsafe_allow_html=True)
...
# ══════════════════════════════════════
    ...
    if st.session_state.wl_success:
        ...
        st.markdown(f"""<a href="https://nexaedge-web-port.streamlit.app" target="_blank" style="display:block;background:rgba(162,255,0,.06);border:1px solid rgba(162,255,0,.25);border-radius:12px;padding:16px 20px;text-decoration:none;margin-bottom:14px;">
        ...
        st.markdown(f'<div style="text-align:right;margin-bottom:10px;"><a href="https://nexaedge-web-port.streamlit.app" target="_blank" style="font-family:\'Space Mono\',monospace;font-size:10px;color:#a2ff00;text-decoration:none;">{already_label}</a></div>', unsafe_allow_html=True)
